...
export default class LoginForm extends React.Component {
    ...
    login() {
        ...
        $.ajax({
            url: 'https://talentservicesidentity20220406143930.azurewebsites.net/authentication/authentication/signin',
            type: 'POST',
            ...
            success: function (response) {
                if (response.isSuccess && response.isEmailVerified) {
                    ...
                    TalentUtil.notification.show("Login Successfully", "success", null, null)
                    this.props.reload();
                } 
