...
export class JobSummaryCard extends React.Component {
    ...
    selectJob(id) {
        ...
        //url: 'https://talentservicestalent20220406144454.azurewebsites.net/listing/listing/closeJob',
        $.ajax({
            url: `https://talentservicestalent20220406144454.azurewebsites.net/listing/listing/getSortedEmployerJobs`,
            headers: {
